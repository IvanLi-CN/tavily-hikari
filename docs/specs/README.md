...
| ----: | ------------------------------------------------------ | ---------------- | ---------------------------------------------------------- | ---------- | ----------------------------------------------------------------------------------------------------------- |
| mx657 | 管理员控制台返回用户控制台入口                         | 已完成           | `mx657-admin-return-user-console-entry/SPEC.md`            | 2026-03-09 | PR #108；visual evidence added；review clear；workflow_dispatch CI run #372 passed on latest SHA            |
