...
| ----: | ------------------------------------------------------ | ---------------- | ---------------------------------------------------------- | ---------- | ---------------------------------------------------------------------------------------------------------------------- |
| a9gkk | Web 共享 shadcn Storybook docs 收口与 CTA 清理         | 部分完成（4/5）  | `a9gkk-web-shared-storybook-docs-cleanup/SPEC.md`          | 2026-03-10 | PR #113 open; addon-docs + primitive stories + AdminShell docs + hero CTA cleanup validated locally                    |
