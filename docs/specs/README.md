...
| ID | Title
| kjdm5 | Web 前端运行时图标内置 | 部分完成（4/5） | `kjdm5-web-bundled-runtime-icons/SPEC.md` | 2026-03-15 | 本地注册 `mdi` / `simple-icons` / `twemoji`，构建产物与页面网络面板均已清除 Iconify 外链；待补 PR / review-loop 收敛 |
| Status | Spec | Last | Notes |
| ----: | ------------------------------------------------------ | ---------------- | ---------------------------------------------------------- | ---------- | --------------------------------------------------------------------------------------------------------------------------- |
| sqt3d | Tavily Hikari 正向代理等价功能对齐 | 已完成（快车道） | `sqt3d-forward-proxy-parity/SPEC.md` | 2026-03-15 | forward proxy parity、admin proxy settings UI、视觉证据与 PR #130 review-loop 收敛完成 |
