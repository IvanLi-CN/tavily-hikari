        ...
        sidebar: {
          '/': [
            ...
            },
            {
              ...
              items: [
                { text: 'Storybook Redirect', link: '/storybook.html' },
                { text: 'Storybook Guide', link: '/storybook-guide.html' },
              ],
            },
          ],
        },
        ...
        sidebar: {
          '/zh/': [
            ...
            },
            {
              text: '验收与预览',
              items: [
                { text: 'Storybook 跳转页', link: '/zh/storybook.html' },
                { text: 'Storybook 导览', link: '/zh/storybook-guide.html' },
              ],
            },
          ],
        },
