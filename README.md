...
- **Admin system status** – `/admin/system-settings/privacy-status` shows the configured/effective upstream identity policy, rollout gates, settlement queue state, and recent reconciliation adjustments without exposing raw upstream credentials.
