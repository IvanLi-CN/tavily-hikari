...
from design_system import generate_design_system, _safe_slug
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Stack-specific search (e.g., html-tailwind, react, nextjs)",
    )
    ...
    if args.design_system:
        ...
        if args.persist:
            project_ref = args.project_name if args.project_name else args.query.upper()
            project_slug = _safe_slug(project_ref, "default")
            print("\n" + "=" * 60)
            print(f"✅ Design system persisted to design-system/{project_slug}/")
            print(f"   📄 design-system/{project_slug}/MASTER.md (Global Source of Truth)")
            if args.page:
                page_slug = _safe_slug(args.page, "page")
