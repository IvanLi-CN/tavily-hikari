...
export const translations: Record<Language, TranslationShape> = {
  en: {
    ...
    public: {
      ...
      heroTagline:
        "Transparent request visibility for your Tavily integration.",
      heroDescription:
      ...
      registrationPaused: {
        ...
        continueHint:
          "If you already have an account, go back to the home page and continue signing in there.",
      },
      registrationPausedNotice: {
        title: "New registration is paused",
        description:
          "Existing users can still sign in with Linux DO. New accounts are temporarily blocked.",
      },
      adminLogin: {
        title: "Admin Login",
      ...
      tokenAccess: {
        ...
        dialog: {
          ...
          description:
            "Enter an access token to view usage and recent requests.",
          actions: {
            cancel: "Cancel",
            confirm: "Continue",
          },
      ...
      logs: {
        ...
        description:
          "Requires a valid access token to view token-specific activity.",
        empty: {
          noToken:
            "Provide a valid access token to view the latest 20 requests for this token.",
      ...
      cherryMock: {
        ...
        tavilyCard: {
          ...
          apiKeyHint:
            "Use your Tavily Hikari access token as the API key here.",
    ...
    admin: {
      header: {
        ...
        subtitle:
          "Monitor API key allocation, quota health, and recent proxy activity.",
      ...
      dashboard: {
        ...
        description:
          "Global health, risk signals, and actionable activity in one place.",
        ...
        todayTitle: "Today",
        todayDescription:
          "Core request signals up to now, compared with the same time yesterday.",
        monthTitle: "This Month",
        monthDescription: "Month-to-date request totals in one compact view.",
        currentStatusTitle: "Current Site Status",
        currentStatusDescription:
          "Live quota, active keys, and pool health right now.",
        ...
        tokenCoverageTruncated:
          "Token risk scope is truncated. Open Tokens for complete coverage.",
        tokenCoverageError:
          "Token risk scope could not be loaded. Open Tokens to retry.",
      },
      modules: {
        ...
        users: {
          ...
          description:
            "Skeleton module reserved for user and role administration.",
          sections: {
            list: "User directory",
        ...
        alerts: {
          title: "Alerts",
          description:
            "Skeleton module reserved for alert rules and notifications.",
          sections: {
            rules: "Alert rules",
        ...
        proxySettings: {
          ...
          description:
            "Skeleton module reserved for proxy and upstream controls.",
          sections: {
      ...
      proxySettings: {
        ...
        description:
          "Manage subscription-first proxy pools, validate candidates, and inspect live node affinity.",
        actions: {
        ...
        summary: {
          ...
          configuredNodesHint:
            "Current selectable pool across manual, subscription, and Direct fallback.",
          readyNodes: "Ready nodes",
          readyNodesHint:
            "Nodes that are both selectable and not currently penalized.",
          penalizedNodes: "Penalized nodes",
          penalizedNodesHint:
            "Nodes under temporary recovery or failure pressure.",
          subscriptions: "Subscriptions",
          subscriptionsHint: "Remote subscription sources currently persisted.",
          manualNodes: "Manual proxies",
          manualNodesHint:
            "Manually pinned proxy candidates kept outside subscriptions.",
          assignmentSpread: "Primary / secondary",
          assignmentSpreadHint:
            "How many upstream keys currently bind to each node tier.",
          range: "Stats range",
        ...
        config: {
          title: "Configuration",
          description:
            "Manage saved subscriptions and manual nodes here. New entries live in dialogs so the page stays easy to scan.",
          ...
          subscriptionsDescription:
            "Persisted subscription sources. Add new feeds from the dialog or remove stale ones here.",
          ...
          manualDescription:
            "Pinned manual nodes kept outside subscriptions for recovery, overrides, or staging.",
          manualPlaceholder:
          ...
          egressDescription:
            "Use one upstream SOCKS5 proxy for every non-direct forward-proxy request so outbound routing stays consistent.",
          ...
          egressUrlHint:
            "Accepts socks5:// or socks5h://. The URL remains editable while the proxy is disabled.",
          egressLockedHint:
            "Disable the egress proxy first if you need to edit the URL.",
          egressRequiredError:
            "Enter a SOCKS5 proxy URL before enabling the egress proxy.",
          egressErrorTitle: "Unable to enable the SOCKS5 egress proxy",
          egressInvalidUrlError:
            "Use a valid socks5:// or socks5h:// proxy URL.",
          egressUnknownError:
            "The SOCKS5 egress proxy could not be enabled. Check the address and try again.",
          egressSwitchLabel: "Enable SOCKS5 egress proxy",
          egressSwitchHint:
            "New non-direct requests switch over only after validation and apply steps finish.",
          ...
          subscriptionIntervalHint:
            "Used by the backend refresh scheduler. Keep it high enough to avoid noisy churn.",
          invalidInterval:
            "Subscription refresh interval must be a positive integer.",
          insertDirectLabel: "Insert Direct fallback",
          insertDirectHint:
            "Keep Direct as a secondary or last-resort route when proxy nodes become unavailable.",
          subscriptionDialogTitle: "Add subscription URL",
          subscriptionDialogDescription:
            "Paste one subscription URL, validate it if you want a preview, or add it directly.",
          subscriptionDialogInputLabel: "Subscription URL",
          manualDialogTitle: "Import proxy nodes",
          manualDialogDescription:
            "Paste one or more manual nodes, optionally validate them first, or import the pasted entries directly.",
        ...
        validation: {
          ...
          description:
            "Run candidate probes before saving to understand parsing, Xray, and reachability failures.",
          empty:
            "No validation results yet. Trigger a validation action to inspect candidate health.",
          emptySubscriptions:
            "Add at least one subscription URL before validating subscriptions.",
          emptyManual:
            "Add at least one manual proxy URL before validating manual candidates.",
          ok: "Reachable",
          failed: "Failed",
          ...
          subscriptionTimedOut:
            "Validation timed out and found no usable nodes",
          subscriptionNoNodes: "The subscription did not resolve to any nodes",
          subscriptionUnsupportedNodes:
            "The subscription did not contain supported nodes",
        ...
        nodes: {
          ...
          description:
            "Observe current node state, window metrics, 24-hour activity, and key affinity spread.",
        ...
        states: {
          ...
          penalized: "Penalized",
          penalizedHint:
            "Temporarily deprioritized until recovery probes succeed.",
          direct: "Direct",
          timeout: "Timeout",
          timeoutHint: "Recent probes timed out before the node could answer.",
          unreachable: "Unreachable",
          unreachableHint:
            "The node is currently failing connection attempts or transport setup.",
          unavailable: "Unavailable",
          unavailableHint: "The node is not selectable right now.",
          xrayMissing: "Xray missing",
          xrayMissingHint:
            "Share-link parsing succeeded, but the local Xray runtime is unavailable.",
        },
        sources: {
          manual: "Manual",
      ...
      users: {
        title: "User Management",
        description:
          "Account-level metrics, tag overlays, and shared quota controls.",
        registration: {
        ...
        usage: {
          title: "User Usage",
          description:
            "Usage-first view for rolling quotas, success rates, token totals, and latest activity.",
        ...
        detail: {
          ...
          tokensTitle: "Tokens",
          tokensDescription:
            "All tokens under this account share the effective quota below.",
        },
        quota: {
          title: "Base Quota",
          description:
            "Edit the account baseline. Tags are applied on top of this baseline.",
        ...
        brokenKeys: {
          ...
          limitDescription:
            "Count only keys that broke this month and are still unavailable now.",
          limitField: "Monthly limit",
          hint: "This limit only applies to the monthly broken-key counter.",
          save: "Save breakage limit",
          saving: "Saving…",
          savedAt: "Saved at {time}",
          invalid: "Monthly broken-key limit must be a non-negative integer.",
          saveFailed: "Failed to update monthly broken-key limit.",
          openAction: "Open broken keys",
          openDetails: "Open monthly broken keys for {label}",
          drawerTitle: "Monthly Broken Keys",
          drawerDescription: "Keys currently counted under {label}.",
          loading: "Loading broken keys…",
          empty: "No broken keys are counted right now.",
          noReason: "No reason",
        ...
        catalog: {
          title: "Tag Catalog",
          description:
            "Review reusable tags, account coverage, and effect settings.",
          summaryTitle: "Tag Coverage",
          summaryDescription:
            "See how many accounts are bound to each tag, then open the tag manager for full maintenance.",
          summaryEmpty: "No user tags available yet.",
          summaryAccounts: "accounts",
          loading: "Loading tag catalog…",
          empty: "No tags available yet.",
          invalid:
            "Please complete the required fields and use integer deltas.",
          ...
          formDescription:
            "Custom tags can group users, add quota, subtract quota, or block all access.",
          systemReadonly:
            "System tags keep their name and icon locked. Only quota effect fields are editable.",
          ...
          blockShort: "BLOCK",
          blockDescription:
            "block_all forces every effective quota dimension to display and enforce as 0.",
          deleteConfirm:
            "Delete tag “{name}”? Existing bindings will be removed too.",
        ...
        userTags: {
          title: "User Tags",
          description:
            "Bind reusable tags to this user. System bindings stay read-only.",
        ...
        effectiveQuota: {
          ...
          description:
            "Effective quota = base quota + all tag deltas, then clamped to zero for display and enforcement.",
          blockAllNotice:
            "A block_all tag is active. Effective quota is fully clamped to 0 for this user.",
      ...
      tokens: {
        ...
        dialogs: {
          delete: {
            title: "Delete Token",
            description:
              "This will permanently remove the access token. Clients using it will receive 401.",
            cancel: "Cancel",
            confirm: "Delete",
          },
          note: {
      ...
      metrics: {
        ...
        subtitles: {
          ...
          keysAvailability:
            "{active} active · {quarantined} quarantined · {exhausted} exhausted",
        },
      ...
      keys: {
        title: "API Keys",
        description:
          "Status, usage, and recent success rates per Tavily API key.",
        placeholder: "New Tavily API Key",
        addButton: "Add Key",
        adding: "Adding…",
        batch: {
          placeholder:
            "Paste text (extract first tvly-dev-* key and public IP per line)",
        ...
        validation: {
          ...
          import: {
            title: "Import Result",
            exhaustedMarkFailed:
              "{count} exhausted keys could not be marked as exhausted",
          },
          summary: {
            group: "Group: {group}",
            inputLines: "Input lines",
        ...
        dialogs: {
          disable: {
            ...
            description:
              "This will stop using the key until you enable it again. No data will be removed.",
            cancel: "Cancel",
            confirm: "Disable",
          },
          delete: {
            ...
            description:
              "This will mark the key as Deleted. You can restore it later by re-adding the same secret.",
            cancel: "Cancel",
            confirm: "Remove",
          },
        },
      ...
      logs: {
        ...
        description:
          "Up to the latest 200 invocations handled by the proxy (20 per page, up to 10 pages).",
        filters: {
          all: "All",
          success: "Success",
          error: "Errors",
      ...
      keyDetails: {
        ...
        quarantine: {
          ...
          description:
            "This key is excluded from rotation until an admin clears the quarantine.",
          source: "Source",
          reason: "Reason",
          detail: "Detail",
        ...
        metadata: {
          ...
          description:
            "Import-time registration metadata extracted from the original account row.",
          group: "Group",
          registrationIp: "Registration IP",
          registrationRegion: "Region",
        },
        stickyUsers: {
          title: "Sticky Users",
          description:
            "Current user bindings on this key, charged credits only.",
        ...
        stickyNodes: {
          title: "Sticky Nodes",
          description:
            "Current primary and secondary proxy nodes for this key.",
  ...
  zh: {
    ...
    public: {
      ...
      registrationPaused: {
        ...
        title: "新用户注册暂时关闭",
        description:
          "当前服务仅允许已注册用户继续登录，暂不接受新的 Linux DO 账户创建本地身份。",
        returnHome: "返回首页",
      ...
      registrationPausedNotice: {
        title: "新注册已暂停",
        description:
          "已注册用户仍可继续使用 Linux DO 登录；新的账户暂时无法创建。",
      },
      adminLogin: {
        title: "管理员登录",
    ...
    admin: {
      ...
      proxySettings: {
        title: "正向代理设置",
        description:
          "以订阅为主配置代理节点，查看实时调度状态，并观察上游 Key 的主备节点亲和。",
        actions: {
          refresh: "刷新统计",
          save: "保存设置",
          saving: "保存中…",
        ...
        config: {
          title: "配置",
          description:
            "这里用于管理已保存的订阅和手工节点；新增动作放进弹窗里，避免把设置页本身挤成大表单。",
          loading: "正在加载代理设置…",
        ...
        validation: {
          title: "验证结果",
          description:
            "在保存前探测候选连通性，提前暴露解析、Xray 或网络可达性问题。",
        ...
        nodes: {
          title: "节点池与实时统计",
          description:
            "查看当前节点状态、窗口统计、24 小时活动，以及主备绑定分布。",
          loading: "正在加载正向代理统计…",
      ...
      users: {
        ...
        catalog: {
          ...
          summaryTitle: "标签账户统计",
          summaryDescription:
            "这里只展示每个标签当前绑定了多少个账户；创建、编辑、删除都在独立标签管理页完成。",
          ...
          formEditTitle: "编辑标签",
          formDescription:
            "自定义标签可用于分组、叠加额度、扣减额度，或直接封禁全部额度。",
          ...
          blockShort: "拉黑",
          blockDescription:
            "block_all 会把所有有效额度维度统一钳制到 0，并参与真实限流。",
        ...
        effectiveQuota: {
          title: "有效额度拆解",
          description:
            "有效额度 = 基础额度 + 所有标签增减，然后统一按 0 做下限钳制。",
          blockAllNotice:
            "当前存在 block_all 标签，这个用户的所有有效额度都会被钳制为 0。",
          baseLabel: "基础额度",
      ...
      tokens: {
        ...
        dialogs: {
          delete: {
            title: "删除令牌",
            description:
              "此操作将永久移除该访问令牌，正在使用它的客户端会收到 401。",
            cancel: "取消",
            confirm: "删除",
          },
          note: {
      ...
      metrics: {
        ...
        subtitles: {
          ...
          keysAvailability:
            "{active} 个可用 · {quarantined} 个隔离中 · {exhausted} 个耗尽",
        },
        loading: "正在加载最新指标…",
      },
      keys: {
        ...
        dialogs: {
          ...
          delete: {
            title: "移除 API Key",
            description:
              "该密钥会被标记为 Deleted，稍后可以通过重新添加同一个密钥来恢复。",
            cancel: "取消",
            confirm: "移除",
          },
        },
      ...
      logs: {
        title: "近期请求",
        description:
          "展示代理最近处理的最多 200 条调用记录，每页 20 条，最多 10 页。",
        filters: {
          all: "全部",
          success: "成功",
          error: "错误",
      ...
      keyDetails: {
        ...
        quarantine: {
          title: "系统隔离",
          description:
            "该密钥当前已被移出轮转池，只有管理员手动解除后才会重新参与调度。",
          source: "来源",
          reason: "原因摘要",
          detail: "原始详情",
          showDetail: "展开原始详情",
...
export function useLanguage(): LanguageContextValue {
  ...
  if (!context) {
    throw new Error(
      "LanguageProvider is missing. Wrap your app with LanguageProvider.",
    );
  }
  return context;
}
