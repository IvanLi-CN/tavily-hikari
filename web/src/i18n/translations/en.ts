    ...
    admin: {
      ...
      systemSettings: {
        ...
        helpLabel: 'Show system settings help', form: {
          ...
          rechargeFeatureLabel: 'Enable recharge',
          rechargeFeatureHint: 'Hides recharge from the user console and rejects new recharge orders. Paid callbacks are still processed.',
          rechargeUserLabel: 'Allow non-admin recharge',
          rechargeUserHint: 'Debug switch. When off, only admin requests can see and create recharge orders.',
