    ...
    admin: {
      ...
      systemSettings: {
        ...
        form: {
          ...
          requestRateLimitHint: 'Sets the maximum requests allowed by the global request-rate limiter in each rolling 5-minute window. Requests over the limit are rate-limited, not merely reported. Saving takes effect on the next authenticated request, but keeps current window counters intact.',
