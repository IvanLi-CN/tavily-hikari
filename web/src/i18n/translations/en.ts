...
export const EN: TranslationShape = {
    ...
    public: {
      updateBanner: {
        ...
        readyFallback: 'The updated app shell is ready. Reload when you want to start using it.',
        description: (current, latest) => `Current ${current} → Ready ${latest}`, refresh: 'Reload now', refreshing: 'Applying update…', retry: 'Retry update', dismiss: 'Remind me later',
      },
