    ...
    admin: {
      ...
      systemSettings: {
        ...
        form: {
          ...
          displayDensityTitle: '列表密度',
          displayDensityDescription: '统一管理端列表的行高、字号和单元格间距。',
          displayDensityComfortable: '一般',
          displayDensityCompact: '紧凑',
          displayDensityStoredHint: '仅保存在当前浏览器，切换后立即应用。',
          accessDisplayTitle: '访问与显示',
          limitsTitle: '全局限制与提示',
          gatewayTitle: 'MCP 网关控制',
          gatewaySectionTitle: 'Session 亲和与 Rebalance',
