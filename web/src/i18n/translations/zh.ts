    ...
    admin: {
      ...
      systemSettings: {
        ...
        helpLabel: '显示系统设置说明', form: {
          ...
          rechargeFeatureLabel: '启用充值功能',
          rechargeFeatureHint: '关闭后用户控制台不展示充值入口，后端也会拒绝创建充值订单；已支付回调仍会继续处理。',
          rechargeUserLabel: '开放非管理员充值',
          rechargeUserHint: '调试开关。关闭后只有管理员请求能看到并创建充值订单。',
